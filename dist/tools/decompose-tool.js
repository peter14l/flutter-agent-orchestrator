...
export async function handleDecomposeFlutterPrompt(args) {
    const prompt = args.prompt;
    const targetPlatforms = args.targetPlatforms;
    const projectName = args.projectName || "flutter_app";
    const stateManagement = args.stateManagement || "riverpod";
    const architecturePattern = args.architecturePattern || "feature-first-clean-architecture";
...
//# sourceMappingURL=decompose-tool.js.map