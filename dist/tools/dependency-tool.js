...
export async function handleResearchFlutterDependencies(args) {
    const projectName = args.projectName || "flutter_app";
    const targetPlatforms = args.targetPlatforms || ["android", "ios"];
...
//# sourceMappingURL=dependency-tool.js.map