...
export class FlutterGoldenTestSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterGoldenTestSpecialistAgent", "Visual Golden Snapshot Testing Specialist", "Generates multi-device golden snapshot test suites for Flutter widgets across Light/Dark modes, mobile, and tablet viewports.");
    }
    generateGoldenTests(spec) {
...
//# sourceMappingURL=golden-test-specialist.js.map