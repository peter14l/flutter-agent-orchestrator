...
export class FlutterDocBlueprintSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterDocBlueprintSpecialistAgent", "Project Specification, Blueprint & Documentation Architect", "Generates comprehensive, dynamic PRD.md, architecture.md, rules.md, phases.md, design.md, and memory.md tailored to user prompts with non-destructive file checking.");
    }
    scaffoldDocuments(spec) {
...
//# sourceMappingURL=doc-blueprint-specialist.js.map