...
export class FlutterCicdSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterCicdSpecialistAgent", "CI/CD, Release & Packaging Engineer", "Generates production GitHub Actions for Split-per-ABI signed APKs, automated gh secret setup, Windows MSIX test signing, and Fastlane.");
    }
    generateCicd(spec) {
...
//# sourceMappingURL=cicd-specialist.js.map