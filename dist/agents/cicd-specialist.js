...
export class FlutterCicdSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterCicdSpecialistAgent", "CI/CD & Release Automation Engineer", "Generates production GitHub Actions workflows for Flutter, Fastlane deployment for iOS/Android, and Web WASM hosting.");
    }
    generateCicd(spec) {
