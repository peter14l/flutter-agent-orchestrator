...
export class FlutterErrorDiagnosticianAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterErrorDiagnosticianAgent", "Flutter & Dart Diagnostic Doctor", "Diagnoses RenderFlex overflows, setState during build errors, pubspec dependency conflicts, CocoaPods build failures, and Riverpod/Bloc issues.");
    }
    diagnose(input) {
...
//# sourceMappingURL=error-diagnostician.js.map