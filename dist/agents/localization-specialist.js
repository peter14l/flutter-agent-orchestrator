...
export class FlutterLocalizationSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterLocalizationSpecialistAgent", "Internationalization (i18n) & Localization (l10n) Specialist", "Extracts UI strings into standard ARB localization bundles, generates l10n.yaml, supports Right-to-Left (RTL) languages, and scaffolds dynamic locale switching.");
    }
    generateLocalization(spec) {
...
//# sourceMappingURL=localization-specialist.js.map