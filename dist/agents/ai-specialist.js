...
export class FlutterAiSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterAiSpecialistAgent", "On-Device & Generative AI Specialist for Flutter", "Scaffolds google_generative_ai SDK integration, streaming StreamProviders, and interactive chat / generation widgets.");
    }
    scaffoldAiModule(spec) {
