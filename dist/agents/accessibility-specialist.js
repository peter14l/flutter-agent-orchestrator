...
export class FlutterAccessibilitySpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterAccessibilitySpecialistAgent", "Accessibility (a11y) & WCAG Compliance Auditor", "Audits Flutter widget trees for screen reader Semantics, minimum 48x48dp touch targets, color contrast, and dynamic text scaling resilience.");
    }
    auditAccessibility(spec) {
...
//# sourceMappingURL=accessibility-specialist.js.map