...
export class FlutterOfflineResilienceSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterOfflineResilienceSpecialistAgent", "Hackathon Wi-Fi Demo Resilience Specialist", "Guarantees zero crashes during live stage pitches by wrapping network repositories in an automatic fallback interceptor that catches Wi-Fi drops and seamlessly serves cached/embedded mock data.");
    }
    scaffoldResilience(spec) {
...
//# sourceMappingURL=offline-resilience-specialist.js.map