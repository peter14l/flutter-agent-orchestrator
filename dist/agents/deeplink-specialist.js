...
export class FlutterDeepLinkSpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterDeepLinkSpecialistAgent", "Deep Linking & Push Notification Routing Engineer", "Configures go_router URI matching, Android App Links (assetlinks.json), iOS Universal Links (apple-app-site-association), and FCM push notification routing.");
    }
    configureRouting(spec) {
...
//# sourceMappingURL=deeplink-specialist.js.map