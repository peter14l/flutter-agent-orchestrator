...
export class FlutterSecuritySpecialistAgent extends BaseFlutterAgent {
    constructor() {
        super("FlutterSecuritySpecialistAgent", "Mobile Security, Cryptography & Privacy Auditor", "Audits Flutter applications for hardcoded secrets, insecure storage, and network vulnerabilities. Scaffolds hardware-backed Keychain/Keystore secure storage, Biometric Auth, and SSL Pinning.");
    }
    auditAndHarden(spec) {
...
//# sourceMappingURL=security-specialist.js.map