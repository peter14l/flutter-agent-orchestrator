...
import { FlutterTestSpec, FlutterTestResult } from "../types.js";

export class FlutterTestingSpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      "FlutterTestingSpecialistAgent",
      "Flutter QA & Test Automation Specialist",
      "Generates Unit tests, Widget tests with testWidgets, Riverpod provider container tests, and mocktail mocks."
    );
  }

  public generateTest(spec: FlutterTestSpec): FlutterTestResult {
