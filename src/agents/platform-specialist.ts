...
export class FlutterPlatformSpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      "FlutterPlatformSpecialistAgent",
      "Native Platform Permissions & Security Engineer",
      "Configures iOS/macOS Info.plist permission strings, AndroidManifest.xml permissions, and Web WASM CanvasKit optimizations."
    );
  }

  public generateConfig(spec: FlutterPlatformConfigSpec): FlutterPlatformConfigResult {
