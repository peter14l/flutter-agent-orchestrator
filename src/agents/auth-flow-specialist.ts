...
export class FlutterAuthFlowSpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      "FlutterAuthFlowSpecialistAgent",
      "Auth, Onboarding & User Profile Flow Specialist",
      "Scaffolds complete animated onboarding tours (PageView with dots), Material 3 Social login UI, and token-persisting Riverpod Auth controllers in seconds."
    );
  }

  public scaffoldAuthFlow(spec: FlutterAuthFlowSpec): FlutterAuthFlowResult {
