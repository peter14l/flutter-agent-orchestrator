...
export class FlutterUISpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      ...
      "Flutter UI/UX & Widget Engineer",
      "Designs production-grade Flutter widgets, Material 3 responsive layouts (Mobile/Web/Desktop), Riverpod/Bloc state integration, and fluid animations."
    );
  }
