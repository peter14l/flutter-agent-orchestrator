...
export class FlutterChartsSpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      "FlutterChartsSpecialistAgent",
      "Interactive Charts & Data Storytelling Specialist",
      "Scaffolds interactive, animated Line charts, Bar graphs, and Donut distribution charts via fl_chart with gradient fills and tooltips."
    );
  }

  public generateChart(spec: FlutterChartsSpec): FlutterChartsResult {
