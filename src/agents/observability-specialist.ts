...
export class FlutterObservabilitySpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      "FlutterObservabilitySpecialistAgent",
      "Telemetry, Crash Reporting & Performance Profiler",
      "Scaffolds Sentry / Firebase Crashlytics crash reporting, type-safe custom analytics event taxonomy, and network/rendering latency tracking."
    );
  }

  public scaffoldObservability(spec: FlutterObservabilitySpec): FlutterObservabilityResult {
