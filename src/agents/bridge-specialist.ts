...
export class FlutterBridgeSpecialistAgent extends BaseFlutterAgent {
  constructor() {
    super(
      "FlutterBridgeSpecialistAgent",
      "Full-Stack API Bridge & Cross-Platform Client Engineer",
      "Generates type-safe Dio REST clients, matching Dart DTO models, Riverpod network providers, and WebSocket realtime streams."
    );
  }

  public generateBridge(spec: FlutterBridgeSpec): FlutterBridgeResult {
