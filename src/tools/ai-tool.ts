import { FlutterAiSpecialistAgent, FlutterAiModuleSpec } from "../agents/ai-specialist.js";
...
export async function handleScaffoldFlutterAiModule(args: any) {
  const spec: FlutterAiModuleSpec = {
