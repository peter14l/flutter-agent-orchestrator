import { FlutterMockFactorySpecialistAgent, FlutterMockFactorySpec } from "../agents/mock-factory-specialist.js";
...
export async function handleGenerateFlutterMockFactory(args: any) {
  const spec: FlutterMockFactorySpec = {
