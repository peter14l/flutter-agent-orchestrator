...
import { FullFlutterPipelineSpec, FlutterPlatform, FlutterStateManagement } from "../types.js";
...
export async function handleOrchestrateFlutterProject(args: any) {
  const spec: FullFlutterPipelineSpec = {
    prompt: args.prompt,
    projectName: args.projectName || "flutter_app",
    targetPlatforms: args.targetPlatforms as FlutterPlatform[] | undefined,
