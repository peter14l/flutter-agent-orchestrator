import { FlutterSecuritySpecialistAgent, FlutterSecurityAuditSpec } from "../agents/security-specialist.js";
...
export async function handleAuditFlutterSecurity(args: any) {
  const spec: FlutterSecurityAuditSpec = {
