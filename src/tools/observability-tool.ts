import { FlutterObservabilitySpecialistAgent, FlutterObservabilitySpec } from "../agents/observability-specialist.js";
...
export async function handleScaffoldFlutterObservability(args: any) {
  const spec: FlutterObservabilitySpec = {
