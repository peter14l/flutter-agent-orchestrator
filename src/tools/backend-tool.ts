...
import { BackendAndStateSpec, FlutterStateManagement } from "../types.js";
...
export async function handleScaffoldFlutterBackend(args: any) {
  const feature = args.featureName as string;
  const spec: BackendAndStateSpec = {
    featureName: feature,
