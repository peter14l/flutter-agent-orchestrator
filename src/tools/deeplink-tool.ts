import { FlutterDeepLinkSpecialistAgent, FlutterDeepLinkSpec } from "../agents/deeplink-specialist.js";
...
export async function handleConfigureFlutterDeepLinks(args: any) {
  const spec: FlutterDeepLinkSpec = {
