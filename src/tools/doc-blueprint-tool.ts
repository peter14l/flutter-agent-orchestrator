import { FlutterDocBlueprintSpecialistAgent, DocBlueprintSpec } from "../agents/doc-blueprint-specialist.js";
...
export async function handleScaffoldFlutterProjectDocs(args: any) {
  const spec: DocBlueprintSpec = {
