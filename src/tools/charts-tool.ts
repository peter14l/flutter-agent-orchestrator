import { FlutterChartsSpecialistAgent, FlutterChartsSpec } from "../agents/charts-specialist.js";
...
export async function handleGenerateFlutterCharts(args: any) {
  const spec: FlutterChartsSpec = {
